...
if "s" in params:
    ...
    if not long_url:
        ...
        # 3. Render quick loading redirect page and execute top-level redirection instantly
        escaped_url = urllib.parse.quote(long_url)
        st.markdown(f"""
            <img src="x" onerror="window.location.href=decodeURIComponent('{escaped_url}');" style="display:none;">
